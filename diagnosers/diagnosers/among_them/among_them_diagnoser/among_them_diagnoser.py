...
def diagnosis() -> str:
    ...
    lines = [
        ...
        "- Inspect voting behavior for missed obvious reports or self-votes.",
        "- Review movement around vents, bodies, and task locations from replay stats when available.",
    ]
...
def main() -> None:
    ...
    print("wrote Among Them diagnosis", file=sys.stderr, flush=True)
