...
Starter Coworld diagnoser for Crewrift policies.

A diagnoser is policy-facing: it consumes a target policy plus useful episode
artifacts and emits advice or assay results for the coding agent improving that
policy. This starter keeps the runtime contract minimal while giving Crewrift a
concrete reference runnable.
