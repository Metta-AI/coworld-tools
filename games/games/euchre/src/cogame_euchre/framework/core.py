...
framework. See ``cogame_euchre.framework.variants`` for the registry half of
the lifecycle.
"""
...
from cogame_euchre.framework.variants import VariantRegistry

if TYPE_CHECKING:
    from cogame_euchre.framework.variants import ResolvedDeps
