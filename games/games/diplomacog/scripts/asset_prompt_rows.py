...
EDGE_ORIENTATIONS = [
    (
        "ew",
        "Horizontal cliff edge segment running east-west, spanning fully from left edge to right edge with no "
        "diagonal sections. High ground/rim with grass tufts is on the north (top) side; low ground/rock face "
        "drop is on the south (bottom) side.",
    ),
    (
        "ew_s",
        "Horizontal cliff edge segment running east-west, spanning fully from left edge to right edge with no "
        "diagonal sections. Depict higher ground on the south (bottom) side that descends northward down a cliff "
        "face to a lower plain on the north (top) side. Grass tufts only on the high rim.",
    ),
    (
        "ns",
        "Vertical cliff edge segment running north-south, spanning fully from top edge to bottom edge with no "
        "diagonal sections. High ground/rim with grass tufts is on the east (right) side; low ground/rock face "
        "drop is on the west (left) side.",
    ),
    (
        "ns_w",
        "Vertical cliff edge segment running north-south, spanning fully from top edge to bottom edge with no "
        "diagonal sections. High ground/rim with grass tufts is on the west (left) side; low ground/rock face "
        "drop is on the east (right) side.",
    ),
]
