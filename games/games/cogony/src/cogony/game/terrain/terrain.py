...
from cogony.terrain import ArenaVariant, find_arena
...
class DesertVariant(ArenaVariant):
    name: str = "desert"
...
class ForestVariant(ArenaVariant):
    name: str = "forest"
...
class CityVariant(ArenaVariant):
    name: str = "city"
...
class CavesVariant(ArenaVariant):
    name: str = "caves"
...
class DistantResourcesVariant(ArenaVariant):
...
class QuadrantBuildingsVariant(ArenaVariant):
