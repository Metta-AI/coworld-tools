"""Observatory config and variant.

Observatories are research nodes (like junctions) that generate 50 creds
...
def observatory_config() -> GridObjectConfig:
    max_coh = 10
...
class ObservatoryVariant(CoGameMissionVariant):
    name: str = "observatory"
    description: str = "Add observatory objects to the map."

    @override
    def modify_env(self, mission: CogonyMission, env: MettaGridConfig) -> None:
        env.game.objects["observatory"] = observatory_config()
