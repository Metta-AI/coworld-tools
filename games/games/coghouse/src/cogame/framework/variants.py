...
straight into :mod:`cogame.variants` and participate in dependency
...
if TYPE_CHECKING:
    from cogame.framework.core import CoGameMission, CoGameMissionVariant, Deps
...
class VariantRegistry:
    ...
    def run_configure(self, variants: list[str], preferred_modules: Sequence[str] | None = None) -> None:
        ...
        from cogame.framework.core import CoGameMissionVariant, Deps  # noqa: PLC0415
